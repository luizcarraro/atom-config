...
function default_1(topPkgs, rootNodeIds, tree, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        pnpm_logger_1.default.info(`Creating dependency tree`);
        const pkgsToLink = yield resolvePeers_1.default(tree, rootNodeIds, topPkgIds, opts.topParents, opts.independentLeaves);
