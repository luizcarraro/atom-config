    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function _install() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const installCtx = yield createInstallCmd(ctx, ctx.skipped);
                if (!ctx.pkg)
                ...
                function run() {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield installInContext(installType, specs, [], ctx, installCtx, opts);
                    });
                }
            });
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function _installPkgs() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                function run() {
                    return installInContext(installType, packagesToInstall, packagesToInstall.map(spec => spec.name), ctx, installCtx, opts);
                }
            });
        }
    });
...
function installInContext(installType, packagesToInstall, newPkgs, ctx, installCtx, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (newPkg) {
            ...
            for (const dep of pkgsToSave) {
                const ref = shrinkwrap_1.pkgIdToRef(dep.id, dep.name, dep.resolution, ctx.shrinkwrap.registry);
                if (dep.dev) {
        ...
        if (!(opts.ignoreScripts || !result.newPkgResolvedIds || !result.newPkgResolvedIds.length)) {
            ...
            yield Promise.all(R.props(result.newPkgResolvedIds, result.linkedPkgsMap)
                ...
                try {
                    yield postInstall_1.default(pkg.hardlinkedLocation, installLogger(pkg.id), {
...
function getSaveSpec(spec, version, saveExact) {
    switch (spec.type) {
        case 'version':
        case 'range':
        case 'tag':
...
function createInstallCmd(ctx, skipped) {
    return __awaiter(this, void 0, void 0, function* () {
        return {
            installs: {},
            localPackages: [],
...
function installLogger(pkgId) {
    return (stream, line) => {
        ...
        pnpm_logger_1.lifecycleLogger[logLevel]({ pkgId, line });
    };
}
