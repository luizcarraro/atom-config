...
function link(linkFrom, linkTo, maybeOpts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!maybeOpts || !maybeOpts.skipInstall) {
            yield install_1.install(Object.assign({}, opts, { prefix: linkFrom, bin: path.join(linkFrom, 'node_modules', '.bin'), global: false }));
        }
        ...
        yield linkBins_1.linkPkgBins(linkFrom, linkToBin);
        if (reporter) {
...
function linkToGlobal(linkFrom, maybeOpts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const opts = yield extendInstallOptions_1.default(maybeOpts);
        const globalPkgPath = pathAbsolute(maybeOpts.globalPrefix);
        yield link(linkFrom, globalPkgPath, Object.assign({}, opts, { linkToBin: maybeOpts.globalBin }));
        if (reporter) {
            logger_1.streamParser.removeListener('data', reporter);
        }
    });
