...
function resolveNpm(spec, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (opts.loggedPkg)
                logInstallStatus_1.default({ status: 'resolving', pkg: opts.loggedPkg });
            ...
            const registryHost = getHost_1.default(correctPkg.dist.tarball);
            const id = createNpmPkgId_1.default(registryHost, correctPkg.name, correctPkg.version);
            const resolution = {
